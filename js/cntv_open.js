...
async function home(filter) {
    const classes = [ 
        ...
        { type_id: "TOPC1451378857272262", type_name: "动画乐园" },
        ...
        { type_id: "TOPC1451463780801881", type_name: "环球科技视野" },
...
async function homeVod() {
    const data = JSON.parse(await request(HOST + '/NewVideo/getVideoListByColumn?id=TOPC1451559129520755&n=10&sort=desc&p=1&mode=0&serviceId=tvcctv'));
...
async function play(flag, id, flags) {
    // console.debug('央视网 id =====>' + id); // js_debug.log
    return JSON.stringify({
        parse: 0,
        url: id,
    })
